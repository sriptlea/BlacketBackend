export enum Forbidden {
    ...
    FRIENDS_BLOCK_EXISTS = "This user is already blocked.",
    FRIENDS_NOT_BLOCKED = "This user is not blocked.",
    FRIENDS_NOT_FRIENDS = "This user is not your friend.",
    FRIENDS_FRIEND_EXISTS = "This user is already your friend.",
    FRIENDS_REQUEST_EXISTS = "This friend request already exists.",
    FRIENDS_REQUEST_NOT_EXISTS = "This friend request does not exist.",
    ...
    STRIPE_SETUP_INTENT_NOT_SUCCEEDED = "The setup intent has not succeeded."
};
