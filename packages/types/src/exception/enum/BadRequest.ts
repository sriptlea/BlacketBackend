export enum BadRequest {
    ...
    STRIPE_PRODUCT_QUANTITY_CAPPED = "This product has a maximum purchase limit of 1.",
    STRIPE_PRODUCT_INVALID_CURRENCY = "This product cannot be purchased with the selected currency",
    STRIPE_PAYMENT_METHOD_REQUIRED = "This product requires a payment method to be used."
};
